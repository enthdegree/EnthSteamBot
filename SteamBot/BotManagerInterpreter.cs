            ...
            p = new CommandSet
                    {
                        ...
                        new BotManagerOption("getbp", "gets a backpack", backpackID => getBackpack(backpackID) ),
                        new BotManagerOption("statbp", "stats a backpack", backpackID => statBackpack(backpackID) )
                    };
        }
